...
function Sidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-56 bg-[#0d1117] border-r border-gray-800 flex flex-col justify-between py-6 px-4">
      {/* Logo */}
      <div>
      ...
      <div className="space-y-1">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-red-400 hover:text-red-300 hover:bg-gray-800 transition w-full"
        >
          <span>⇤</span>
          Log Out
        </button>
